    ...
    <SiteShell>
      <article className="legal-page section-padding mx-auto max-w-3xl py-12">
        ...
        <section className="legal-block">
          ...
          <p>
            На сайте может использоваться Яндекс.Метрика (включая вебвизор, карту кликов и скроллинга)
            для статистики посещений и улучшения сервиса. Скрипт аналитики загружается только после
            вашего согласия через баннер cookies. Вы можете принять или отклонить аналитику, а также
            изменить выбор позже через ссылку «Cookies» в подвале сайта.
          </p>
          <p>
            Без согласия cookies аналитики не устанавливаются нами намеренно; технически необходимые
            данные для работы сайта (например, сессия оформления заказа) могут использоваться для
            исполнения запроса.
          </p>
        </section>

        <section className="legal-block">
          <h2>6. Согласие на заказ</h2>
          <p>
