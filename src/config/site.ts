...
export const siteConfig = {
  ...
  hours: "с 10:00 до 20:00",
  hoursLabel: "РАБОТАЕМ С 10:00 ДО 20:00",
  city: "Ростов-на-Дону",
  ...
  seo: {
    ...
    description:
      "PC Барбершоп — мужские стрижки, борода и стайлинг. Ростов-на-Дону, Батуринская 165/13. Работаем с 10:00 до 20:00. Онлайн-запись и заказ косметики с самовывозом.",
  },
} as const;
