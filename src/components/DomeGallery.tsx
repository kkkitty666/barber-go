...
type GalleryImageInput = string | GalleryImage;
...
const DEFAULT_IMAGES: GalleryImage[] = [
  {
    src: "https://images.unsplash.com/photo-1621605815971-fbc98d665033?q=80&w=774&auto=format&fit=crop",
    alt: "Мужская стрижка",
  },
  {
    src: "https://images.unsplash.com/photo-1503951914875-452162b0f3f0?q=80&w=774&auto=format&fit=crop",
    alt: "Барбер за работой",
  },
  {
    src: "https://images.unsplash.com/photo-1599351431202-1e0f0137899a?q=80&w=774&auto=format&fit=crop",
    alt: "Стрижка бороды",
  },
  {
    src: "https://images.unsplash.com/photo-1622286342628-98a781e9ed4d?q=80&w=774&auto=format&fit=crop",
...
function buildItems(pool: GalleryImageInput[], seg: number): ItemDef[] {
...
export default function DomeGallery({
  ...
  const originalTilePositionRef = useRef<TilePosition | null>(null);
  ...
  useEffect(() => {
    ...
    const close = () => {
      ...
      if (originalImg) {
        const clonedImg = originalImg.cloneNode() as HTMLImageElement;
